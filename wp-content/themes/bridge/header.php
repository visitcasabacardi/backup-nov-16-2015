							...
							<div class="two_columns_50_50 clearfix">
								<div class="column1 footer_col1">
									<div class="column_inner">
                                        ...
                                        <div class="textwidget"><p><a href="https://bookings.visitcasabacardi.com/" target="_blank"><i class="fa fa-calendar fa-lg simple_social" style="font-size: 17px; color: #fff"></i> Online Booking Now Available</a></p></div>
		</div>									</div>
								</div>
								<div class="column2 footer_col2">
									<div class="column_inner">
										<div id="text-3" class="widget widget_text social-hide">
                                        <div class="textwidget" style="float:right">
                                        <span style="top:6px;left:5px;" class="q_social_icon_holder normal_social"><a href="http://www.tripadvisor.com/Attraction_Review-g147320-d150138-Reviews-Casa_Bacardi-San_Juan_Puerto_Rico.html" target="_blank"><img src="//www.jpxdesigns.com/bacardi2//file/2015/06/icon-tripadvisor-02.jpg"> </a></span>
                                        
                                        <span class="q_social_icon_holder normal_social"><a href="https://www.facebook.com/bacardidistillerytour" target="_blank"><i class="fa fa-facebook fa-lg simple_social" style="font-size: 17px; color: #fff !important"></i></a></span>

<span class="q_social_icon_holder normal_social"><a href="http://instagram.com/casabacarditour" target="_blank"><i class="fa fa-instagram fa-lg simple_social" style="font-size: 17px; color: #fff !important"></i></a></span>

<span class="q_social_icon_holder normal_social"><a href="https://www.youtube.com/channel/UCMcab9GwTF6h8OG9BfSCvTw" target="_blank"><i class="fa fa-youtube fa-lg simple_social" style="font-size: 17px; color: #fff !important"></i></a></span></div>
		</div>									</div>
								</div>
							</div>
					 </div>
