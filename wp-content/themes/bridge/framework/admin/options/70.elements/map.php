...
$panel16->addChild("full_screen_sections_nav_title",$full_screen_sections_nav_title);
	...
	$group5 = new QodeGroup("Navigation Position","Choose navigation buttons position");
	$panel16->addChild("group5",$group5);

		$row1 = new QodeRow();
		$group5->addChild("row1",$row1);

			$fss_navigation_button_position = new QodeField("selectsimple","fss_navigation_button_position","","Position","This is some description",array(
				"" => "Default",
				"side_by_side" => "Arrows Side By Side"
				));
			$row1->addChild("fss_navigation_button_position",$fss_navigation_button_position);
