...
class OPanda_ConnectOptionsMetaBox extends FactoryMetaboxes321_FormMetabox
{
 ...
 ?>
    ...
    public function getLinkedInErrors() {
            ...
            if ( empty( $apiKey ) ) {
                return array(
                    'text' => sprintf( __('You need to get a LinkedIn API Key for your website. Please <a href="%s" target="_blank">click here</a> to learn more.', 'signinlocker'), admin_url('admin.php?page=settings-bizpanda&opanda_screen=social') )
                );
            }
