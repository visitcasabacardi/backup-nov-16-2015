...
//	print_r($atts);
	...
	$out .= 'if(!jQuery().dcSocialStream) { $.getScript("'.plugins_url() . '/wordpress-social-stream/js/jquery.social.stream.1.5.13.min.js", function(){$("#social-stream-'.$id.'").dcSocialStream(config);}); } else {';
