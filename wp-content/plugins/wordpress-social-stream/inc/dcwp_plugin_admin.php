...
if(!class_exists('dcwp_plugin_admin_dcwss')) {
	...
	class dcwp_plugin_admin_dcwss {
		...
		function dcwp_advert() {
			...
			$content .= '<li class="last"><a href="http://www.designchemical.com/blog/index.php/premium-wordpress-plugins/premium-wordpress-plugin-social-network-tabs/" class="dc-external"><img src="'.plugins_url() . '/wordpress-social-stream/images/dcsnt_250_125.png" alt="Social Network Tabs For WordPress" /></a></li>';
			$content .= '<li><a href="http://www.designchemical.com/blog/index.php/premium-wordpress-plugins/wordpress-social-share-buttons/" class="dc-external"><img src="'.plugins_url() . '/wordpress-social-stream/images/dcwsb_250_125.png" alt="WordPress Social Share Buttons" /></a></li>';
			$content .= '</ul>';
